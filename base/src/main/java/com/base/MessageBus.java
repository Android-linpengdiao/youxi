...
public class MessageBus {
    ...
    //音视频
    public static final String msgId_call_onCallOutgoing = "onCallOutgoing";
    public static final String msgId_call_onCallConnected = "onCallConnected";
    public static final String msgId_call_onCallDisconnected = "onCallDisconnected";
    public static final String msgId_call_onRemoteUserJoined = "onRemoteUserJoined";
    public static final String msgId_call_onRemoteUserInvited = "onRemoteUserInvited";
    public static final String msgId_call_onRemoteUserLeft = "onRemoteUserLeft";
    public static final String msgId_call_onCallTime = "onCallTime";
    ...
    public static final String msgId_chatMessage = "chatMessage";
    public static final String msgId_logout = "logout";
    public static final String msgId_updateUser = "updateUser";
    public static final String msgId_updateName = "updateName";
    public static final String msgId_timeLineNum = "timeLineNum";
    public static final String msgId_timeLineRefresh = "timeLineRefresh";
    public static final String msgId_chatUnread = "chatUnread";
    public static final String msgId_clubRefresh = "clubRefresh";
    public static final String msgId_progress = "progress";
    public static final String msgId_toggleEllipsize = "toggleEllipsize";
    public static final String msgId_songTest = "songTest";
    public static final String msgId_updateSongTest = "updateSongTest";
