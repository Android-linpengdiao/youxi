...
import com.base.R;
import com.base.view.ProgressView;
...
public class LoadingManager {
    ...
    public static void showProgress(final Activity activity, final String progress,Listener listener) {
        progressView = null;
        progressView = new ProgressView(activity, R.style.LoadingDialogTheme,listener);
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                progressView.show();
