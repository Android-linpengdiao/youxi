...
public class ImSocketThread {

    private static final String TAG = "ImSocketThread";
    ...
    public ImSocketMap smMap;

    private static ImSocketThread mInstance;

    public static ImSocketThread getInstance() {
        if (mInstance == null) {
            Log.d(TAG, "getInstance: null ");
            mInstance = new ImSocketThread();
        }
        return mInstance;
    }
