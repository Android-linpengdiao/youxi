...
public class PushSocketThread {
    ...
    public PushSocketMap smMap;

    private static PushSocketThread mInstance;

    public static PushSocketThread getInstance() {
        if (mInstance == null) {
            Log.d(TAG, "getInstance: null ");
            mInstance = new PushSocketThread();
        }
        return mInstance;
    }
