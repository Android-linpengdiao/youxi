...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private TextView numIndicatorInside, numIndicator;
    ...
    private void setTitleStyleUI() {
        ...
        if (titleTextSize != -1) {
            bannerTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, titleTextSize + getConfigTextSize());
        }
    ...
    private float getConfigTextSize() {
        ...
        if (textSize == 0) {
            return getContext().getResources().getDimensionPixelSize(com.base.R.dimen.sp_m_2);

        } else if (textSize == 1) {
            return getContext().getResources().getDimensionPixelSize(com.base.R.dimen.sp_0);

        } else if (textSize == 2) {
            return getContext().getResources().getDimensionPixelSize(com.base.R.dimen.sp_4);

        } else if (textSize == 3) {
            return getContext().getResources().getDimensionPixelSize(com.base.R.dimen.sp_8);

        } else if (textSize == 4) {
            return getContext().getResources().getDimensionPixelSize(com.base.R.dimen.sp_12);
