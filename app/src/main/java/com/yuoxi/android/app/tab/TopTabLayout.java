...
public class TopTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link TopTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TopTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private int mTabIndicatorDrawableResId;
    ...
    public TopTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TopTabLayout, defStyleAttr, R.style.YJTabLayoutStyle);

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabPaddingBottom,
                mTabPaddingBottom);
        mTabIndicatorPaddingTop = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorPaddingTop, mTabIndicatorPaddingTop);
        mTabIndicatorPaddingBottom = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorPaddingBottom, mTabIndicatorPaddingBottom);
        mTabIndicatorPaddingLeft = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorPaddingLeft, mTabIndicatorPaddingLeft);
        mTabIndicatorPaddingRight = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorPaddingRight, mTabIndicatorPaddingRight);
        mTabIndicatorDrawableHeight = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorDrawableHeight, mTabIndicatorDrawableHeight);
        mTabTextAppearance = a.getResourceId(R.styleable.TopTabLayout_yj_tabTextAppearance, R.style.TextAppearance_Design_Tab);
        ...
        if (a.hasValue(R.styleable.TopTabLayout_yj_tabTextSize)) {
            mTabTextSize = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabTextSize, 0);
        }

        if (a.hasValue(R.styleable.TopTabLayout_yj_tabSelectTextSize)) {
            mTabSelectTextSize = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabSelectTextSize, 0);
        }
        if (a.hasValue(R.styleable.TopTabLayout_yj_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.TopTabLayout_yj_tabTextColor);
        }

        if (a.hasValue(R.styleable.TopTabLayout_yj_tabSelectedTextColor)) {
            // We have an explicit open text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.TopTabLayout_yj_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabMaxWidth,
                INVALID_WIDTH);
        mTabIndicatorDrawableResId = a.getResourceId(R.styleable.TopTabLayout_yj_tabIndicatorDrawable, 0);
        mTabBackgroundResId = a.getResourceId(R.styleable.TopTabLayout_yj_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabContentStart, 0);
        mMode = a.getInt(R.styleable.TopTabLayout_yj_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.TopTabLayout_yj_tabGravity, GRAVITY_FILL);
        ...
        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.TopTabLayout_yj_tabIndicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.TopTabLayout_yj_tabIndicatorColor, 0));
    ...
    /**
     * Sets the tab indicator's color for the currently open tab.
     *
    ...
    /**
     * Sets the tab indicator's height for the currently open tab.
     *
    ...
    public void changedTableUI(int id1, int selectCor, int noSelectCor) {
        mTabIndicatorDrawableResId = id1;

        mTabStrip.changedUI();

//        setSelectedTabIndicatorColor(cor);

        setTabTextColors(createColorStateList(noSelectCor, selectCor));
        invalidate();
    }
     ...
     * <p>
     * Calling this method does not update the open tab, it is only used for drawing purposes.
     *
     * @param position           current scroll position
     * @param positionOffset     Value from [0, 1) indicating the offset from {@code position}.
     * @param updateSelectedText Whether to update the text's open state.
     */
    ...
    void setScrollPosition(int position, float positionOffset, boolean updateSelectedText,
        ...
        // Update the 'open state' view as we scroll, if enabled
     ...
     * If this is the first tab to be added it will become the open tab.
     *
     ...
     *
     * @param tab         Tab to add
     * @param setSelected True if the added tab should become the open tab.
     */
    ...
    /**
     * Returns the position of the current open tab.
     *
     * @return open tab position, or {@code -1} if there isn't a open tab.
     */
    ...
    /**
     * Remove a tab from the layout. If the removed tab was open it will be deselected
     * and another tab will be open if present.
     *
    ...
    /**
     * Returns the current mode used by this {@link TopTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * Gets the text colors for the different states (normal, open) used for the tabs.
     */
    @Nullable
    ...
    /**
     * Sets the text colors for the different states (normal, open) used for the tabs.
     *
    ...
    /**
     * The one-stop shop for setting up this {@link TopTabLayout} with a {@link ViewPager}.
     * <p>
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (mCurrentVpSelectedListener != null) {
            // If we already have a tab open listener for the ViewPager, remove it
        ...
        if (viewPager != null) {
            ...
            // Now we'll add a tab open listener to set ViewPager's current item
    ...
    public interface OnTabSelectedListener {
        ...
        /**
         * Called when a tab enters the open state.
         *
         * @param tab The tab that was open
         */
        void onTabSelected(Tab tab);

        /**
         * Called when a tab exits the open state.
         *
        ...
        /**
         * Called when a tab that is already open is chosen again by the user. Some applications
    ...
    public static final class Tab {
        ...
        /**
         * Returns true if this tab is currently open.
         */
     ...
     * necessary calls back to the provided {@link TopTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TopTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(TopTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TopTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
...
//                final Resources res = getResources();
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (mMode == MODE_FIXED && textSize > curTextSize && curLineCount == 1) {
                        ...
                        // To combat that we check to ic_see if the change in text size
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                ...
                // Else, we'll ic_see if there is a TextView or ImageView present and update them
                if (mCustomTextView != null || mCustomIconView != null) {
                    updateTextAndIcon(mCustomTextView, mCustomIconView);
                }
            }

            // Finally update our open state
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                left = selectedTitle.getLeft() + mTabIndicatorPaddingLeft;
                right = selectedTitle.getRight() - mTabIndicatorPaddingRight;

                if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                    // Draw the selection partway between the tabs
                    View nextTitle = getChildAt(mSelectedPosition + 1);
                    left = (int) (mSelectionOffset * (nextTitle.getLeft() + mTabIndicatorPaddingLeft) +
                            (1.0f - mSelectionOffset) * left);
                    right = (int) (mSelectionOffset * (nextTitle.getRight() - mTabIndicatorPaddingRight) +
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mBitmap != null) {
                    canvas.drawBitmap(mBitmap, mIndicatorLeft + (mIndicatorRight - mIndicatorLeft - mBitmap.getWidth()) * 0.5f, getMeasuredHeight() - mBitmap.getHeight() - mTabIndicatorPaddingBottom + mTabIndicatorPaddingTop, mSelectedIndicatorPaint);
                } else {
